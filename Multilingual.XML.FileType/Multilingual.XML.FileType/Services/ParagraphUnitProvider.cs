...
namespace Multilingual.XML.FileType.Services
{
	public class ParagraphUnitProvider
	{
		...
		public ParagraphUnitResult GetUpdatedParagraphUnit(IParagraphUnit paragraphUnitLeft, IParagraphUnit paragraphUnitRight,
			MultilingualXmlImportSettings settings)
		{
		...
		private bool SegmentIsExcluded(MultilingualXmlImportSettings settings, ISegmentPair segmentPair, ISegmentPair updatedSegmentPair)
		{
			if (segmentPair != null)
			{
