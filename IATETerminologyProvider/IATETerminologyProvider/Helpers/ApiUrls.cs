...
namespace IATETerminologyProvider.Helpers
{
	public class ApiUrls
	{
		...
		{
			return $"https://iate.europa.eu//em-api/inventories/_term-types?expand={expand}&trans_lang={transLang}&limit={limit}&offset={offset}";
		}
		...
		{
			var encodedString = HttpUtility.UrlEncode(currentSelection);
			var uri = $"https://iate.europa.eu/search/byUrl?term={encodedString}&sl={sourceLanguage}&tl={targetLanguage}";
			return uri;
		}
	}
}