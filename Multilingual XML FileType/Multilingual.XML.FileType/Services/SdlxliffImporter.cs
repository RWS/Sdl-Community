...
namespace Multilingual.XML.FileType.Services
{
	public class SdlxliffImporter
	{
		...
		public ImportResult UpdateFile(List<IParagraphUnit> updatedParagraphUnits, MultilingualXmlImportSettings settings, string filePathInput, string filePathOutput)
		{
