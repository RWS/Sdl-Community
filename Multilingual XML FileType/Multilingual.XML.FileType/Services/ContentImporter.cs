...
namespace Multilingual.XML.FileType.Services
{
	public class ContentImporter : AbstractBilingualContentProcessor
	{
		...
		private readonly MultilingualXmlImportSettings _settings;
		private readonly FilterItemService _filterItemService;
		private readonly SegmentBuilder _segmentBuilder;
		private readonly SegmentVisitor _segmentVisitor;


		public ContentImporter(List<IParagraphUnit> updatedParagraphUnits, MultilingualXmlImportSettings settings,
