...
{
    /// <summary>
    /// Interaction logic for WPFWizardWindowControls.xaml
    /// </summary>
        ...
        public WindowsControl()
        {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Loaded, new Action(() =>
            {
                if (string.IsNullOrWhiteSpace(ControlMinimize))
                    ControlMinimize = StringResources.WindowsControl_Minimize;
                if (string.IsNullOrWhiteSpace(ControlMaximize))
                    ControlMaximize = StringResources.WindowsControl_Maximize;
                if (string.IsNullOrWhiteSpace(ControlClose))
                    ControlClose = StringResources.WindowsControl_Close;
                if (string.IsNullOrWhiteSpace(ControlRestore))
                    ControlRestore = StringResources.WindowsControl_Restore;
                if (string.IsNullOrWhiteSpace(ControlHelp))
                    ControlHelp = StringResources.WindowsControl_Help;
            }));
        }
