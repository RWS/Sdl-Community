...
namespace CustomViewExample.Services
{
	public class UsefulTipsService
	{
		...
		private readonly CustomViewPathInfo _customViewPathInfo;
		...
		{
			var tipsLanguageFullPath = Path.Combine(_customViewPathInfo.TipsFullPath, languageId);
		...
		{
			var tipsEmbeddedResource = typeof(PluginResources).Namespace + ".UsefulTips." + languageId + "." + languageId + ".zip";
