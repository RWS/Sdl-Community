				...
				<xsl:for-each select="Report/Summary">
					<table class="InfoList">
						<tr>
							...
							<td class="InfoData"><xsl:value-of select="Task" /></td>
						</tr>
						<tr>
							<td class="InfoItem">Project:</td>
							<td class="InfoData"><xsl:value-of select="Project" /></td>
						</tr>
						<tr>
							<td class="InfoItem">Due Date:</td>
							<td class="InfoData"><xsl:value-of select="DueDate" /></td>
						</tr>
						<tr>
							<td class="InfoItem">Language:</td>
							<td class="InfoData"><xsl:value-of select="Language" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="InfoData"><xsl:value-of select="CreatedAt" /></td>
						</tr>
					</table>
				</xsl:for-each>
