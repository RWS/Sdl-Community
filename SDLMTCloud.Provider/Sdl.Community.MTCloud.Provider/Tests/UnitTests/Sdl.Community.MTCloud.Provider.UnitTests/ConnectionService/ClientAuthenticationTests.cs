...
namespace Sdl.Community.MTCloud.Provider.UnitTests.ConnectionService
{
	public class ClientAuthenticationTests
	{
		...
		[Fact]
		public void ClientCredential_ExpiryDateIsValid_ReturnTrue()
		{
		...
		[Fact]
		public void ClientCredential_ExpiryDateIsValid_ReturnFalse()
		{
			var credential = _common.GetDefaultCredential(Authentication.AuthenticationType.Client);			
		...
		[Fact]
		public void ClientCredential_NameIsValid_ReturnFalse()
		{
			var credential = _common.GetDefaultCredential(Authentication.AuthenticationType.Client);
		...
		[Fact]
		public void ClientCredential_PasswordIsValid_ReturnFalse()
		{
			var credential = _common.GetDefaultCredential(Authentication.AuthenticationType.Client);			
