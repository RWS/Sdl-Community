...
{
	public abstract class BaseTellMeAction : AbstractTellMeAction
	{
		...
		protected BaseTellMeAction(string name, Icon icon, string[] helpKeywords, bool isAvailable, string url = null, Action customAction = null)
		{
			_url = url;
