...
namespace Sdl.Community.ApplyTMTemplate.ViewModels
{
    public class MainWindowViewModel : ModelBase
    {
        ...
        private string _currentApplyTMSettingsMessage;
        private System.Windows.Media.Brush _currentApplyTMSettingsColor = System.Windows.Media.Brushes.Black;
        ...
        public string CurrentApplyTMMessage
        {
            get => _currentApplyTMSettingsMessage;
            set
            {
                _currentApplyTMSettingsMessage = value;
                OnPropertyChanged(nameof(CurrentApplyTMMessage));
            }
        }

        public System.Windows.Media.Brush CurrentApplyTMMessageColor
        {
            get => _currentApplyTMSettingsColor;
            set
            {
                _currentApplyTMSettingsColor = value;
                OnPropertyChanged(nameof(CurrentApplyTMMessageColor));
            }
        }
        ...
        private string GetValidApplyTMMessage(string path)
