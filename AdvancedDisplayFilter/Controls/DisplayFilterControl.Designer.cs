...
namespace Sdl.Community.AdvancedDisplayFilter.Controls
{
    partial class DisplayFilterControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tags_tooltip.SetToolTip(this.alsoTags_radioButton, StringResources.DisplayFilter_IncludeTags_Tooltip);
            ...
            this.tags_tooltip.SetToolTip(this.onlyTags_radioButton, StringResources.DisplayFilter_OnlyTags_Tooltip);
