...
namespace Sdl.Community.MTEdge.UnitTests.SDLMTEdgeTranslationProviderTests
{
	...
	public class TranslationProviderLanguageDirectionTests
	{
		public TranslationProviderLanguageDirectionTests()
		{
			...
			options.ApiToken = UTStringResource.ApiKey;
		...
		public void SearchSegment_PlainString_ValidTranslation()
		{
			...
			Assert.AreEqual(UTStringResource.BasicTranslation, results[0].MemoryTranslationUnit.TargetSegment.ToString());
		}
		...
		public void SearchTranslationUnits_WithAndWithoutTags_ValidTranslations()
		{
			...
			Assert.AreEqual(UTStringResource.BasicTranslation, results[0][0].MemoryTranslationUnit.TargetSegment.ToString());
			Assert.AreEqual(UTStringResource.TaggedTranslation, results[1][0].MemoryTranslationUnit.TargetSegment.ToString());
		}
