...
public class LanguageMappingProviderViewModel : BaseViewModel
{
    ...
    private readonly PluginVersion _pluginVersion;

    private IList<LanguageMapping> _filteredMappedLanguages;
    private IList<LanguageMapping> _mappedLanguages;
    ...
    private void ApplyFilter()
    {
        ...
        FilteredMappedLanguages = [.. filteredContent];
    }
    ...
    private void RetrieveMappedLanguagesFromDatabase()
    {
        ...
        MappedLanguages = [.. newMappedLanguages];
        ApplyFilter();
    }
