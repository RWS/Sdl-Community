...
namespace TMProvider
{
    ...
    public class XmlSanitizingStreamReader : StreamReader
    {
        ...
        /// </param>
        public XmlSanitizingStreamReader(Stream streamToSanitize, Encoding encoding)
            : base(streamToSanitize, encoding, true)
        { }
        ...
        /// </summary>
        /// <param name="xml11">
        /// True to check for XML 1.1; false for XML 1.0
        /// </param>
        public static bool IsLegalXmlChar(bool xml11, int character)
        {
            if (xml11) // http://www.w3.org/TR/xml11/#charsets
            {
                return
                !(
                     character <= 0x8 ||
            ...
            else // http://www.w3.org/TR/REC-xml/#charsets
            {
                return
                (
                     character == 0x9 /* == '\t' == 9   */          ||
        ...
        {
            return XmlSanitizingStreamReader.IsLegalXmlChar(false, character);
        }
        ...
        public override int Read()
        {
            ...
            while (!XmlSanitizingStreamReader.IsLegalXmlChar(nextCharacter));
        ...
        public override int Peek()
        {
            ...
            (
                ...
                !XmlSanitizingStreamReader.IsLegalXmlChar(nextCharacter) &&
