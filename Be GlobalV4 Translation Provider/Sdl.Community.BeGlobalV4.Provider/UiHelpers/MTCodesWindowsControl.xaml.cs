...
{
	/// <summary>
	/// Interaction logic for MTCodesWindowsControl.xaml
	/// </summary>
	public partial class MTCodesWindowsControl : UserControl
	{
		/// <summary>
		///     Identifies the <see cref="ControlHelp" /> property.
		/// </summary>
		public static readonly DependencyProperty HelpProperty =
			DependencyProperty.Register("ControlHelp", typeof(string), typeof(MTCodesWindowsControl),
		...
		public static readonly DependencyProperty CloseProperty =
			DependencyProperty.Register("ControlClose", typeof(string), typeof(MTCodesWindowsControl),
				new PropertyMetadata(string.Empty));
		...
		public static readonly DependencyProperty MaximizeProperty =
			DependencyProperty.Register("ControlMaximize", typeof(string), typeof(MTCodesWindowsControl),
				new PropertyMetadata(string.Empty));
		...
		public static readonly DependencyProperty MinimizeProperty =
			DependencyProperty.Register("ControlMinimize", typeof(string), typeof(MTCodesWindowsControl),
				new PropertyMetadata(string.Empty));
		...
		public static readonly DependencyProperty RestoreProperty =
			DependencyProperty.Register("ControlRestore", typeof(string), typeof(MTCodesWindowsControl),
				new PropertyMetadata(string.Empty));
