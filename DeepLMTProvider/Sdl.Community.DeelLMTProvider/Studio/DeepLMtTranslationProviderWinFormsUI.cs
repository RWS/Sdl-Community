...
namespace Sdl.Community.DeepLMTProvider.Studio
{
    ...
    public class DeepLMtTranslationProviderWinFormsUI : ITranslationProviderWinFormsUI
    {
        ...
        public ITranslationProvider[] Browse(IWin32Window owner, LanguagePair[] languagePairs, ITranslationProviderCredentialStore credentialStore)
        {
            ...
            //get credentials
            var credentials = GetCredentials(credentialStore, Helpers.Helpers.DeeplTranslationProviderScheme);
        ...
        public bool Edit(IWin32Window owner, ITranslationProvider translationProvider, LanguagePair[] languagePairs, ITranslationProviderCredentialStore credentialStore)
        {
            ...
            var savedCredentials = GetCredentials(credentialStore, Helpers.Helpers.DeeplTranslationProviderScheme);
        ...
        private void SetDeeplCredentials(ITranslationProviderCredentialStore credentialStore, string apiKey, bool persistKey)
        {
            ...
            var uri = new Uri(Helpers.Helpers.DeeplTranslationProviderScheme);
