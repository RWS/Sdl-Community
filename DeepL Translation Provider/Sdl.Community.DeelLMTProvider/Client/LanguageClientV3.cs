...
namespace Sdl.Community.DeepLMTProvider.Client
{
    ...
    public class LanguageClientV3
    {
        ...
        public static async Task<List<SupportedLanguage>> GetSupportedLanguagesAsync(string type, string product, string apiKey, string baseUrl)
        {
        ...
        /// </summary>
        /// <param name="type">Type of languages to retrieve: "source" or "target"</param>
        /// <param name="product">Product to retrieve languages for</param>
        /// <param name="apiKey">DeepL API key</param>
        /// <param name="baseUrl">Base URL for the DeepL API</param>
        /// <returns>List of supported languages</returns>
        public static List<SupportedLanguage> GetSupportedLanguages(string type, string product, string apiKey, string baseUrl)
        {
            return GetSupportedLanguagesAsync(type, product, apiKey, baseUrl).GetAwaiter().GetResult();
        }

        /// <summary>
        /// Retrieves all source languages from DeepL API V3 for translate_text product
        /// </summary>
        /// <param name="apiKey">DeepL API key</param>
        /// <param name="baseUrl">Base URL for the DeepL API</param>
        ...
        {
            return await GetSupportedLanguagesAsync("source", "translate_text", apiKey, baseUrl);
        }

        /// <summary>
        /// Retrieves all target languages from DeepL API V3 for translate_text product
        /// </summary>
        /// <param name="apiKey">DeepL API key</param>
        /// <param name="baseUrl">Base URL for the DeepL API</param>
        ...
        {
            return await GetSupportedLanguagesAsync("target", "translate_text", apiKey, baseUrl);
        }
        ...
        /// <summary>
        /// Gets language metadata including features support
        /// </summary>
        /// <param name="languageCode">Language code to get metadata for</param>
        /// <param name="type">Type of language: "source" or "target"</param>
        /// <param name="apiKey">DeepL API key</param>
        /// <param name="baseUrl">Base URL for the DeepL API</param>
        /// <param name="product">Product to check features for (defaults to "translate_text")</param>
        /// <returns>SupportedLanguage object with metadata, or null if not found</returns>
        public static async Task<SupportedLanguage> GetLanguageMetadataAsync(string languageCode, string type, string apiKey, string baseUrl, string product = "translate_text")
        {
            if (string.IsNullOrEmpty(languageCode))
                return null;
