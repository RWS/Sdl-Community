...
namespace TMX_Lib.Search
{
	...
	internal class TextSegment
	{
		...
		private static int CompareScore(TextSegment a, TextSegment b, int minScore)
		{
		...
		public int CompareScore(string b, int minScore)
		{
			var other = new TextSegment(b);
			return CompareScore(this, other, minScore);
		}


		private int ConcordanceSearchMatch(TextSegment fullText, int minScore)
		{
