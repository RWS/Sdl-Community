	...
	public class TestDataUtil
	{
		...
		public List<Project> GetDefaultTestProjectData()
		{
			...
			{				
				...
				{
					var backProject = GetBackProject(project.Customer, "Back-" + project.Name + "-" + targetLanguage.CultureInfo.Name,
						targetLanguage.CultureInfo, new List<CultureInfo> {project.SourceLanguage.CultureInfo});
					// Create back-project
					project.BackTranslationProjects.Add(backProject);
				}
			}
		...
		private Project GetProject(Customer customer, string projectName, CultureInfo sourceLanguage, IEnumerable<CultureInfo> targetLanguages)
		{
