...
namespace Sdl.Community.Reports.Viewer.TestData
{
	public class TestDataUtil
	{
		public List<Report> GetTestReports()
		{
			...
			report1.Name = "Conversion report (Date 101)";
			...
			report2.Name = "Some Conversion report (Date 101)";
			...
			report3.Name = "Italian conversion report(Date 102)";
			...
			report4.Name = "Export files report (Date 106)";
			...
			report5.Name = "Some custom task (Date 107)";
