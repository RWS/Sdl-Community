...
namespace Sdl.Community.MtEnhancedProvider.Helpers
{
	public sealed class Log
	{
		...
		private Log()
		{
			...
			var logDirectoryPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), _constants.SDLCommunity, _constants.SDLMTEnhanced);
			...
			{
				FileName = Path.Combine(logDirectoryPath, _constants.SDLMTEnhancedLogFile),
