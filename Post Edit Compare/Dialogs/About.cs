...
namespace Sdl.Community.PostEdit.Versions.Dialogs
{
    public partial class About : Form
    {
        public About()
        {
            ...
            labelCopyright.Text = "";//AssemblyCopyright; //SDLCOM-3582 -Valentin temporary commented until those copyrights information will  be clarified
		...
		//SDLCOM-3582 -Valentin temporary commented until those copyrights information will  be clarified
		//"License agreement\r\n"
		// + "\r\n"
