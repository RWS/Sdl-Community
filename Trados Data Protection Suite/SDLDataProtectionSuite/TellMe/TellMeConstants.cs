...
{
    internal static class TellMeConstants
    {
        public const string PluginName = "Trados Data Protection Suite";
        public const string TellMe_Name = "Trados Data Protection Suite";
