...
{
    public partial class PanelComparisonProjects : DockContent
    {
        public PanelComparisonProjects()
        {
            InitializeComponent();
        ...
        private void Panel_ComparisonProjects_Load(object sender, EventArgs e)
        {
