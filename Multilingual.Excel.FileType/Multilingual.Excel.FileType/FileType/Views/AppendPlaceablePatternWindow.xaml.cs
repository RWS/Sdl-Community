...
{	
	public partial class AppendPlaceablePatternWindow : Window
	{
		...
		private readonly AppendPlaceablePatternViewModel _model;

		public AppendPlaceablePatternWindow(AppendPlaceablePatternViewModel model, Window parentWindow)
		{			
			InitializeComponent();
