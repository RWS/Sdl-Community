...
namespace Multilingual.Excel.FileType.BatchTasks.ViewModels
{
	public class ImportSettingsViewModel : BaseModel
	{
		...
		public ImportSettingsViewModel(MultilingualExcelImportSettings settings)
		{
			Settings = settings;
		...
		public MultilingualExcelImportSettings SaveSettings()
		{
		...
		public MultilingualExcelImportSettings ResetToDefaults()
		{
