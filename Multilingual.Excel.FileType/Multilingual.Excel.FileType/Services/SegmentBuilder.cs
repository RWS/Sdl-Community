	...
	public class SegmentBuilder
	{
		...
		public IContextInfo CreateMultilingualParagraphContextInfo()
		{
			var multilingualParagraphContextInfo =
				ItemFactory.PropertiesFactory.CreateContextInfo(FiletypeConstants.MultilingualParagraphUnit);
			multilingualParagraphContextInfo.Purpose = ContextPurpose.Information;
			multilingualParagraphContextInfo.DisplayCode = "MP";
			multilingualParagraphContextInfo.ContextType = FiletypeConstants.MultilingualParagraphUnit;
		...
		public IContextInfo CreateExcelContextParagraphContextInfo(string name, string value)
		{
			var multilingualParagraphContextInfo = ItemFactory.PropertiesFactory.CreateContextInfo(FiletypeConstants.MultilingualExcelContextInformation);
			multilingualParagraphContextInfo.Purpose = ContextPurpose.Information;
			multilingualParagraphContextInfo.DisplayCode = FiletypeConstants.ExcelContextInformationDisplayCode;
			multilingualParagraphContextInfo.ContextType = FiletypeConstants.MultilingualExcelContextInformation;
