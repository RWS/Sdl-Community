...
namespace Sdl.Community.Qualitivity.WarningWindow;
...
{
	public static readonly DependencyProperty ActionTitleProperty = DependencyProperty.Register(nameof(ActionTitle), typeof(string), typeof(SettingsActionWarning), new PropertyMetadata(default(string)));
	...
	private readonly string _url = "https://appstore.rws.com/Plugin/16?tab=documentation";

	public SettingsActionWarning(string text, string actionTitle)
	{
		InitializeComponent();
		Text = text;
