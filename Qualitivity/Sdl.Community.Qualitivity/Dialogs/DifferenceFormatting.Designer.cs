...
{
    partial class DifferenceFormatting
    {
        /// <summary>
        ...
        private Button button_fontColorEdit;
        private Button button_backroundColorEdit;
        private GroupBox groupBox_styles;
        private GroupBox groupBox_sample;
        ...
        internal ComboBox comboBox_styleBold;
        internal ComboBox comboBox_styleUnderline;
        internal ComboBox comboBox_styleStrikethrough;
        internal ComboBox comboBox_styleItalic;
        internal RichTextBox richTextBox_sample;
        internal CheckBox checkBox_fontColor;
        internal Label label_fontColorDisplay;
        internal Label label_backroundColorDisplay;
        internal CheckBox checkBox_backroundColor;
        internal ComboBox comboBox_stylePosition;
