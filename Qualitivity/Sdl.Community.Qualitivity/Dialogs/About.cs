...
namespace Sdl.Community.Qualitivity.Dialogs
{
    public partial class About : Form
    {
        ...
        + "1.1 Your use of SDL AppStore, including its web pages, products, software (including software made available for download) and services (together the “Services”), is subject to the terms of a legal agreement between you and SDL plc of Globe House, Clivemont Road, Maidenhead SL6 7DY, England (“SDL”). "+"\r\n"
        + "1.2 Unless otherwise agreed in writing between you and SDL, this agreement includes, at a minimum, the terms and conditions set out in this document and Terms and Conditions for the use of any SDL websites including but not limited to: sdl.com; appstore.sdl.com, translationzone.com, community.sdl.com; languagecloud.sdl.com ('SDL Websites')."+"\r\n"
        ...
        + "ii. SDL is required to do so by law (for example, where the provision of the Services to you is, or becomes, unlawful); or "+"\r\n"
        + "iii. SDL intends to withdraw provision of the Services from users of a profile to which you belong, "+"\r\n"
        + "or for no reason. "+"\r\n"
