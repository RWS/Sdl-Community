...
namespace Sdl.Community.Qualitivity.Dialogs
{
    public partial class About : Form
    {
        public About()
        {
            ...
            Text = PluginResources.About_Qualitivity_for_SDL_Trados_Studio_2019;
            ...
            labelCopyright.Text = "";//AssemblyCopyright; //SDLCOM-3583 - Valentin-> Temporary commented until will be clarified
		...
		//SDLCOM-3583 - Valentin-> Temporary commented until will be clarified
		//	"License agreement\r\n"
		//+ "\r\n"
