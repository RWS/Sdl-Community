...
3. In order to clone the repository using Source Tree from menu select "Clone/New", an popup will appear [CloneRepository](https://github.com/sdl/Sdl-Community/blob/master/cloneRepository.png). In source path paste this path : "https://github.com/sdl/Sdl-Community.git", in destination path select a path where the repository should be stored on your drive.
