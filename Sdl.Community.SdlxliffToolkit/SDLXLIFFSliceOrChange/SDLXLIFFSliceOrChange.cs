...
using Sdl.Community.SDLXLIFFSliceOrChange.FolderSelect;
using Sdl.Community.SDLXLIFFSliceOrChange.ResourceManager;
...
{
    public partial class SDLXLIFFSliceOrChange : Form
    {
        ...
        private void btnSelectFolder_Click(object sender, EventArgs e)
        {
            ...
            selectFolder.InitialDirectory = String.Format(@"{0}\Studio 2011\Projects",
