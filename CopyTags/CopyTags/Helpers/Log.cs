...
namespace SDLCopyTags.Helpers
{
	public sealed class Log
	{
		...
		private Log()
		{
			...
			var logDirectoryPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "SDL Community", "SDLCopyTags");
			...
			{
				FileName = Path.Combine(logDirectoryPath, "SDLCopyTagsLogs.txt"),
