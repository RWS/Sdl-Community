...
using MicrosoftTranslatorProvider.Studio.TellMe.View;
using MicrosoftTranslatorProvider.Studio.TellMe.ViewModel;
...
namespace MicrosoftTranslatorProvider.Studio.TellMe
{
    class SettingsAction : TellMeAction
    {
        ...
        private static void ShowDialog()
        {
            ...
            var providerViewModel = new ProviderConfigurationViewModel(selectedTranslationOptions, languagePairs.ToArray());
            var providerView = new ProviderConfigurationView() { DataContext = providerViewModel };
        ...
        private static bool IsGoogleCloudProvider(TranslationProviderReference translationProviderReference)
        {
            return translationProviderReference is not null
                && translationProviderReference.Uri.Scheme.StartsWith(Constants.MicrosoftProviderScheme);
        }
    }
}