...
namespace Sdl.Community.DsiViewer.ViewModel
{
	public class DsiViewerViewModel : ModelBase, IDisposable
	{
		...
		public ICommand ApplySdlMtCloudFilter => _applySdlMtCloudFilter = _applySdlMtCloudFilter ?? new CommandHandler(() => ApplyFilter(), true);
		public ICommand ClearSdlMtCloudFilter => _clearSdlMtCloudFilter = _clearSdlMtCloudFilter ?? new CommandHandler(() => ApplyFilter(true), true);
		...
		public FilterApplier FilterApplier { get; set; } = new FilterApplier();
