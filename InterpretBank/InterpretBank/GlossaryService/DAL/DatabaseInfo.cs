...
namespace InterpretBank.GlossaryService.DAL
{
	...
	public class DatabaseInfo : IInterpretBankTable
	{
		...
		[Column(Name = "FieldTermLabel")]
		public string FieldTermLabel { get; set; }

		[Column(Name = "ID")]
		public int Id { get; set; }

		[Column(Name = "LanguageName1")]
		public string LanguageName1 { get; set; }

		[Column(Name = "LanguageName10")]
		public string LanguageName10 { get; set; }

		[Column(Name = "LanguageName2")]
		public string LanguageName2 { get; set; }

		[Column(Name = "LanguageName3")]
		public string LanguageName3 { get; set; }

		[Column(Name = "LanguageName4")]
		public string LanguageName4 { get; set; }

		[Column(Name = "LanguageName5")]
		public string LanguageName5 { get; set; }

		[Column(Name = "LanguageName6")]
		public string LanguageName6 { get; set; }

		[Column(Name = "LanguageName7")]
		public string LanguageName7 { get; set; }

		[Column(Name = "LanguageName8")]
		public string LanguageName8 { get; set; }

		[Column(Name = "LanguageName9")]
		public string LanguageName9 { get; set; }
	}
}