namespace Sdl.Community.FileTypeSupport.MXLIFF
{
    ...
    {
        public const string PluginName = "MXLIFF File Type";
        ...
        public static readonly string TellMe_SourceCode_Url = "https://github.com/RWS/Sdl-Community/tree/master/FileTypeSupport.MXLIFF";
        public static readonly string TellMe_Documentation_Name = $"{PluginName} Documentation";
        public static readonly string TellMe_Documentation_Url = "https://appstore.rws.com/Plugin/29?tab=documentation";
