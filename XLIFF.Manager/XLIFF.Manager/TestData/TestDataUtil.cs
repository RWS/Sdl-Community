...
namespace Sdl.Community.XLIFF.Manager.TestData
{
	public class TestDataUtil
	{
		...
		public List<Project> GetTestProjectData()
		{
			...
			projects.Add(GetProject(customer1, "Project 101", new CultureInfo("en-US"), new List<CultureInfo> { new CultureInfo("it-IT"), new CultureInfo("de-DE") }));
