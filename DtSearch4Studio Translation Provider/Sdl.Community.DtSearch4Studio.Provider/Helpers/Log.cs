...
namespace Sdl.Community.DtSearch4Studio.Provider.Helpers
{
	public sealed class Log
	{
		...
		private Log()
		{
			...
			var logDirectoryPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "SDL", "DtSearch4StudioLogs");
			...
			{
				FileName = Path.Combine(logDirectoryPath, "DtSearch4StudioLogs.txt"),
