namespace Sdl.Community.SdlFreshstart.Helpers
{
	public static class LocationsDescription
	{
		...
		public static string ProgramDataPluginsPath => "This location contains the sdlplugins you have installed from the SDL AppStore that are going to be shared across multiple users, usually in an Enterprise environment to avoid having to maintain multiple copies of the same files on every machine." +
